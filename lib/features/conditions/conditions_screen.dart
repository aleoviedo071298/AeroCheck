        ...
        children: [
          ...
          _MetricGrid(
            metrics: [
              ...
              _Metric('Kp', _fmt(weather.kpIndex), Icons.sensors_rounded),
            ],
          ),
          const SizedBox(height: 12),
...
class _LocationHeader extends StatelessWidget {
  const _LocationHeader({required this.report});
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Mock operativo - ${report.weather.time.hour.toString().padLeft(2, '0')}:00',
