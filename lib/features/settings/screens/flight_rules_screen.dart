          ...
          child: ListView(
            ...
            children: [
              ...
              _stepperPair(
                ...
                onWarn: (v) => _set(
                    (c) => c.copyWith(precipProbabilityWarningPercent: v)),
                onBlock: (v) => _set(
                    (c) => c.copyWith(precipProbabilityBlockedPercent: v)),
              ),
              _stepperPair(
                ...
                onWarn: (v) => _set(
                    (c) => c.copyWith(precipIntensityWarningMmPerHour: v)),
                onBlock: (v) => _set(
                    (c) => c.copyWith(precipIntensityBlockedMmPerHour: v)),
              ),
